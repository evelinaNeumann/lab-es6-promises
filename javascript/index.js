...
// Bonus 2 - Promise all
// Obtain the cooking instructions for Brussels Sprouts
const brusselsSproutsInstructions = [];

for (let i = 0; i < brusselsSprouts.length; i++) {
  brusselsSproutsInstructions.push(obtainInstruction('brusselsSprouts', i));
}

// Use Promise.all to wait for all the instructions to be obtained
Promise.all(brusselsSproutsInstructions)
  .then((steps) => {
    ...
    readyLi.innerHTML = "Brussels sprouts are ready!";
